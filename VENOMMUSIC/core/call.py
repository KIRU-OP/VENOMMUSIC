...
from VENOMMUSIC.utils.inline.play import colored_stream_markup, colored_stream_markup_timer
from VENOMMUSIC.utils.colored_buttons import buttons_to_inline_markup, smart_send_photo
from VENOMMUSIC.utils.stream.autoclear import auto_clean

logger = logging.getLogger(__name__)
from VENOMMUSIC.utils.thumbnails import get_thumb, get_thumb_url
from VENOMMUSIC.utils.errors import capture_internal_err, send_large_error
from VENOMMUSIC.utils.pastebin import VISHALBIN
        ...
        try:
            ...
            if last_title and await is_autoplay_on(chat_id):
                try:
                    ...
                    from VENOMMUSIC.utils.database import is_active_chat as _is_chat_active
