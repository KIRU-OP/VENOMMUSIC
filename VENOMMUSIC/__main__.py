...
from VENOMMUSIC.utils.cookie_handler import fetch_and_store_cookies
...
async def init():
    ...
    try:
        ...
        LOGGER("VENOMMUSIC").info("ʏᴏᴜᴛᴜʙᴇ ᴄᴏᴏᴋɪᴇs ʟᴏᴀᴅᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ ✅")
    except Exception as e:
        LOGGER("VENOMMUSIC").warning(f"⚠️ ᴄᴏᴏᴋɪᴇ ᴇʀʀᴏʀ: {e}")
    ...
    LOGGER("VENOMMUSIC.plugins").info("ᴍᴏᴅᴜʟᴇs ʟᴏᴀᴅᴇᴅ...")
    ...
    LOGGER("VENOMMUSIC").info("✅ Vishal music Bot Started Successfully!")
    await idle()
    await app.stop()
    await userbot.stop()
    LOGGER("VENOMMUSIC").info("sᴛᴏᴘᴘɪɴɢ ᴍᴜsɪᴄ ʙᴏᴛ ...")
            ...
            try:
                ...
                if _sync_db is not None:
                    try:
                        ...
                        LOGGER("VENOMMUSIC").warning(f"DB stats error: {db_error}")
...
<div class="f"><p>Auto-refreshes every 30s</p><p style="margin-top:8px"><a href="https://t.me/{config.BOT_USERNAME}">Open Bot</a> • <a href="https://t.me/ItsMeVishalBots">Developer</a></p></div>
                ...
                LOGGER("VENOMMUSIC").error(f"Flask home error: {e}")
        ...
        def api_stats():
            ...
            try:
                ...
                LOGGER("VENOMMUSIC").error(f"Flask API stats error: {e}")
