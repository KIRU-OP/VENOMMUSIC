...
from VENOMMUSIC.mongo.welcomedb import is_on, bump, cool, auto_on
from VENOMMUSIC.utils.colored_buttons import styled_button, buttons_to_inline_markup

BG_PATH = "VENOMMUSIC/assets/VISHAL/welcome.png"
FALLBACK_PIC = "VENOMMUSIC/assets/upic.png"
FONT_PATH = "VENOMMUSIC/assets/VISHAL/Arimo.ttf"
...
def build_pic(av, fn, uid, un):
    ...
    # 'VENOMMUSIC/assets/vishal/welcome.png' file.
...
async def welcome(client, update: ChatMemberUpdated):
    ...
    try:
        ...
        for f in (avatar, img):
            if f and os.path.exists(f) and "VENOMMUSIC/assets" not in f:
                try:
                    os.remove(f)
                except:
                    pass
